...
import databaseproject.app.controller.OnUpdateProductQ;
...
public class SellerProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDateAdded = findViewById(R.id.dateAdded);
        mCategory = findViewById(R.id.category);
        mDesc = findViewById(R.id.description);
        quantityEditText = findViewById(R.id.quantity_edit);
    ...
    private class UpdateQuantity extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                new OnUpdateProductQ(P_ID, Integer.parseInt(quantityEditText.getText().toString())).execute();
